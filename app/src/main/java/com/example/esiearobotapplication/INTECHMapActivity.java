...
public class INTECHMapActivity extends AppCompatActivity
{
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intech_map);
        ...
        ImageView imageView = findViewById(R.id.intech_image_view_detail);
        TextView textViewStand = findViewById(R.id.intech_text_view_stand_detail);
        TextView textViewLieu = findViewById(R.id.intech_text_view_lieu_detail);
        TextView textViewMap = findViewById(R.id.intech_text_view_conference_detail);
