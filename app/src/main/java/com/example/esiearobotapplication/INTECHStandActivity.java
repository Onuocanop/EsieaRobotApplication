...
public class INTECHStandActivity extends AppCompatActivity implements StandAdapter.OnItemClickListener
 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intech_stand);

        recyclerView = findViewById(R.id.intechRecyclerView);
        ...
        call.enqueue(new Callback<JSONResponse>()
        {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response)
            {
                ...
                standList = new ArrayList<>(Arrays.asList(jsonResponse.getIntechStand()));
